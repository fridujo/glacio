...
import com.github.fridujo.glacio.running.api.configuration.ConfigurationBuilder;
import com.github.fridujo.glacio.running.api.configuration.GlacioInitializer;
...
class DiscoveryTests {
    ...
    public static class TestInitializer implements GlacioInitializer {
        @Override
        public ConfigurationBuilder initialize(ConfigurationBuilder configurationBuilder) {
            return configurationBuilder.addFeaturePath("classpath:features/exec");
        }
    }
}
